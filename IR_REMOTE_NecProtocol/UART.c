...
void printData(uint32_t prtData) {//print 4 bytes of Data
    uint8_t temp1, temp2, temp3, temp4;
    
    DISABLE_UART0_INTERRUPT;
    temp1 = (prtData &0x000000FF);
    temp2 = (prtData &0x0000FF00)>>8;
    temp3 = (prtData &0x00FF0000)>>16;
    temp4 = (prtData &0xFF000000)>>24;

    temp1 = (unsigned char) temp1;
    temp2 = (unsigned char) temp2;
    temp3 = (unsigned char) temp3;
    temp4 = (unsigned char) temp4;
    
    uartTxChar((unsigned char)temp4);
    uartTxChar((unsigned char)temp3);
